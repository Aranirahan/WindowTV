...
public class TabFragment2 extends Fragment {
    ...
    private int[] IMAGEgrid = {R.drawable.z1, R.drawable.z2, R.drawable.z3, R.drawable.z4, R.drawable.z5, R.drawable.z6,R.drawable.z1, R.drawable.z2, R.drawable.z3, R.drawable.z4, R.drawable.z5, R.drawable.z6};
    private String[] TITLeGgrid = {"Paradise", "Waterfall World", "For The Forest",  "America's West", "Bird and Water", "Autumn River","Paradise", "Waterfall World", "For The Forest",  "America's West", "Bird and Water", "Autumn River"};
    ...
    private String[] Dategrid = {"2 hours","1 hour","1 hour", "1 hour", "8 hour","9 hour","2 hours","1 hour","1 hour", "1 hour", "8 hour","9 hour"};
